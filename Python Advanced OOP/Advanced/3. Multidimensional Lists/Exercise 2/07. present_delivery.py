def cookie_func(presents_left, total_nice_kids):
    ...
    return presents_left, total_nice_kids
...
while command != "Christmas morning":
    ...
    if house == "V":
        ...
        presents, nice_kids_visited = cookie_func(presents, nice_kids_visited)

    neighbourhood[santa_pos[0]][santa_pos[1]] = "-"

    if not presents or nice_kids == nice_kids_visited:
        break
